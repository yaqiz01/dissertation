...
Most compilers, such as LLVM, use control flow graphs to represent the control in an imperative program.
...
\Cref{fig:spatialegpar} shows an example of a control flow graph vs. a control hierarchy.
