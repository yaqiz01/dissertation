...
Plasticine is a tiled-based reconfigurable dataflow accelerator designed for wide ranges of data-intensive
workloads.
...
Plasticine runs at 1GHz with a thermal design power at 49W. 
Previous work has shown a up to 77X performance-per-watt improvement from Plasticine over a Stratix V FPGA.
