...
\Cref{fig:partcycleeg} shows a valid and invalid solution for a dataflow graph with cycle.
...
$B$ has the dimension of number of nodes by number of partitions, where$B[i,j]==1$ indicates that
