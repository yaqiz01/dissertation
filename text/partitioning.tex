...
We can formulate the problem of where to partition in the dataflow graph as an optimization problem, shown in
\Cref{tab:partprob}.
...
\begin{tabular}{lp{12cm}}
  ...
  \begin{minipage}{12cm}
  \begin{outline}
  \0 Each partition must not exceeds the limit on number of \vspace{-0.2cm}
    \1 live in/out variables (I/O ports) \vspace{-0.2cm}
    \1 operations (pipeline stages), \vspace{-0.2cm}
    \1 and live variables across stages (pipeline registers), etc.\vspace{-0.2cm}
