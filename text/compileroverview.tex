...
Therefore, the multi-cycle handshaking signals can lead to significant pipeline bubbles
...
pipeline. 
\name maps a subset of the address computation externally in other PUs and 
generates control tokens among the distributed writers, time-sharing the write port and enforcing the
