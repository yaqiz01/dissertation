...
controllers distributed in other PUs, as shown in \Cref{fig:centralctrl}.
...
the remotely distributed accessors, as shown in \Cref{fig:centralctrl}.
...
all innermost controllers are perfectly nested, as shown in \Cref{fig:splitctrl}.
...
\emph{C} in \Cref{fig:spatialegpar}. This allow us to limit the synchronization among a small set of distributed nodes, 
