...
increase while increasing the parallelization factor on output dimension of all layers of the
MLP.
...
A common loop optimization on procesor-based architecture is to move loop-invariant expressions 
