...
are typically not supported on dataflow accelerators, such as branches and while loops.
To enable this, the control path of the architecture must permit data-dependency.
