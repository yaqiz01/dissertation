...
\Cref{fig:loopdivision} gives an example of loop fusion vs. loop division.
...
\Cref{fig:loopdivisionillegal} gives an example of invalid loop fission and correct loop division.
