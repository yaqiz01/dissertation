...
\begin{figure}
\centering
\includegraphics[width=1\columnwidth]{network/figs/util_bw2.pdf}
\caption{Physical resource and bandwidth utilization for various applications.}\label{fig:util_bw}
\centering
\includegraphics[width=1\columnwidth]{network/figs/link7.pdf}
...
\begin{figure}
\centering
\includegraphics[width=1\columnwidth]{network/figs/graph.pdf}
