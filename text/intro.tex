...
\Cref{fig:peakutil} illustrates a trade-off between the average utilization of the peak FLOPS 
...
\caption[Average utilization vs. peak compute density trade-off]{
 ...
 density. 
 While GPUs and fix-function accelerators have a high FLOPS density, they are prone to
